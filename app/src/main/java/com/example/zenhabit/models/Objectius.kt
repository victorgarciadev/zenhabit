...
class Objectius(nom: String, descripcio: String, categoria: String, dataLimit: String, repetible:Dies?, horari:String?, complert: Boolean, ultimaDataFet: Date?, tipus: Boolean) {
    val nom = nom
